...
tem_8_caracteres = len(senha) >= 8 #quantidade de caracteres na senha é maior ou igual a 8 

tem_numero = any(char.isdigit() for char in senha) #percorrendo a string para ver se tem número
tem_letra = any(char.isalpha() for char in senha)#percorrendo a string para ver se tem letra 
if tem_8_caracteres and tem_letra and tem_letra: #usando os operadores de condições 
    print("Senha forte")
else:
    print("Senha fraca")
...
# Exercicio 5
lista = [10, 11, 13, 27, 22, 24, 2, 3, 9, 6, 8,]
