...
print(a ** b) # Ou seja (10 x 10 x 10)
...
numero_quebrado = 1.4256789

print(round(numero_quebrado, 2)) #(2) representa o numero de casas que deve ser exibida ao usuario
